        ...
        <div class="relative z-10 flex flex-col md:flex-row items-center gap-8">
          ...
          <div class="text-center md:text-right flex-1">
            ...
            <div class="flex flex-wrap justify-center md:justify-start items-center gap-x-4 gap-y-2 text-dark-400">
               <span class="flex items-center gap-2"><svg class="w-4 h-4 text-primary-500" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path d="M10 6H5a2 2 0 00-2 2v9a2 2 0 002 2h14a2 2 0 002-2V8a2 2 0 00-2-2h-5m-4 0V5a2 2 0 114 0v1m-4 0a2 2 0 104 0m-4 0H5m14 0h-5" /></svg> {{ s.academicYear ? (s.academicYear.name + ' (' + getSchoolTypeLabel(s.academicYear.typeSchool) + ')') : 'غير محدد' }}</span>
          ...
          <div class="glass-card p-6 lg:p-8 border-dark-800">
             ...
             <div class="grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-6">
                ...
                <div>
                   ...
                   <p class="text-white font-bold">{{ s.academicYear ? (s.academicYear.name + ' — ' + getSchoolTypeLabel(s.academicYear.typeSchool)) : 'غير محدد' }}</p>
                </div>
                <div>
